...
export default function Hero({ onOpenResume }) {
  ...
  return (
    <section
      id="top"
      ref={ref}
      className="reveal mx-auto flex min-h-screen max-w-6xl items-center px-4 pt-16 sm:px-6"
    >
      <div className="grid w-full items-center gap-10 md:grid-cols-2">
        <div className="flex justify-center md:justify-end">
          <ProfileAvatar className="h-48 w-48 md:h-72 md:w-72" />
        </div>

        <div className="w-full max-w-2xl overflow-hidden rounded-2xl border border-slate-800 bg-slate-950/70 shadow-2xl shadow-indigo-500/10 ring-1 ring-white/5 backdrop-blur">
